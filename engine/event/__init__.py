...
__all__ = ["Event", "Key", "KeyPress", "KeyRelease", "KeyRepeat", "Mouse", "MouseButton", "MousePress", "MouseRelease", "Window", "WindowClose", "WindowResize", "WindowFocus", "WindowFocusGain", "WindowFocusLose", "MouseMove"]