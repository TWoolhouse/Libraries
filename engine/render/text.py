...
class Font:
    ...
    def size(self, value: int=None) -> int:
...
class Text(Primitive):
    ...
    def Transform(self, translate: Vector=Vector(0, 0), rotation: float=0.0, scale: Vector=Vector(1, 1)) -> 'Text':
